...
import com.wonder.common.exception.ExceptionStackUtil;
...
public class ExceptionLogAspect {
    ...
    @Pointcut("execution(* com.wonder.blog.web.view.admin.controller..*.*(..)) || execution(* com.wonder.blog.web.view.view.controller..*.*(..))")
