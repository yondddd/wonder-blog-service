package com.wish.blog.cache.redis;

import com.wish.blog.cache.redis.script.IncrScript;
...
public class RedisCache<T> {
    ...
    public Long incrBy(String key, long amount, int seconds) {
        return redisTemplate.opsForValue().getOperations()
                .execute(RedisScript.of(IncrScript.INCR_EXPIRE, Long.class), List.of(key), amount, seconds);
    }
