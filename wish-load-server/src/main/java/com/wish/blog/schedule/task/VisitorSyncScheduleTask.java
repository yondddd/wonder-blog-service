package com.wish.blog.schedule.task;

import com.wish.blog.cache.redis.VisitCache;
...
import com.wish.blog.web.view.dto.VisitLogUuidTime;
...
public class VisitorSyncScheduleTask {
    ...
    public void syncVisitInfoToDatabase() {
        ...
        //记录昨天的PV和UV
        visitRecordService.insert(new VisitRecordDO(pv, uv, date));
