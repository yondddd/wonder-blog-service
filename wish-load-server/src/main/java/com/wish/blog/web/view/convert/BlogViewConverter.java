...
import com.wish.blog.web.view.vo.BlogCategoryVO;
import com.wish.blog.web.view.vo.BlogDetailVO;
import com.wish.blog.web.view.vo.BlogTagVO;
import com.wish.blog.web.view.vo.BlogVO;
import com.wish.common.constant.BlogConstant;
...
public class BlogViewConverter {
    ...
    public static List<BlogVO> do2vo(List<BlogDO> from,
        ...
        for (BlogDO blogDO : from) {
            ...
            CategoryDO category = categoryMap.get(blogDO.getCategoryId());
            if (category != null) {
    ...
    public static BlogDetailVO do2detail(BlogDO from, CategoryDO category, List<TagDO> tags) {
        ...
        to.setContent(MarkdownUtils.markdownToHtmlExtensions(from.getContent()));
