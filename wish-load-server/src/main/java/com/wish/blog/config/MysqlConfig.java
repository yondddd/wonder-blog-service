...
@Configuration
@MapperScan(basePackages = "com.wish.blog.mapper", sqlSessionFactoryRef = "blogSqlSessionFactory")
public class MysqlConfig {
    ...
    public DataSource getDateSource1() {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://" + host + ":3306/wish_load?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true");
