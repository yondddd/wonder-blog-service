...
public class BlogAdminController {
    ...
    @PostMapping("/blog")
    public Result saveBlog(@RequestBody com.yond.blog.model.dto.Blog blog) {
    ...
    @PutMapping("/blog")
    public Result updateBlog(@RequestBody com.yond.blog.model.dto.Blog blog) {
     ...
     * @return
     */
    private Result getResult(com.yond.blog.model.dto.Blog blog, String type) {
        //验证普通字段
