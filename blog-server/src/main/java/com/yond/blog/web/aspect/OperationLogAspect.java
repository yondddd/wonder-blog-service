...
public class OperationLogAspect {
    ...
    public Object logAround(ProceedingJoinPoint joinPoint, OperationLogger operationLogger) throws Throwable {
        ...
        currentTime.remove();
        OperationLogDO operationLog = handleLog(joinPoint, operationLogger, times);
    ...
    private OperationLogDO handleLog(ProceedingJoinPoint joinPoint, OperationLogger operationLogger, int times) {
        ...
        OperationLogDO log = new OperationLogDO(username, uri, method, description, ip, times, userAgent);
