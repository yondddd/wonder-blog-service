package com.yond.blog.util.markdown;

import com.yond.blog.util.markdown.ext.cover.CoverExtension;
import com.yond.blog.util.markdown.ext.heimu.HeimuExtension;
...
public class MarkdownUtils {
    ...
    //转换table的HTML
    private static final List<Extension> tableExtension = List.of(TablesExtension.create());
    //任务列表
