...
import com.yond.util.HashUtils;
import com.yond.util.IpAddressUtils;
import com.yond.util.MailUtils;
import com.yond.util.QQInfoUtils;
import com.yond.util.comment.channel.ChannelFactory;
import com.yond.util.comment.channel.CommentNotifyChannel;
...
public class CommentUtils {
     ...
     */
    public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.yond.entity.Comment parentComment) {
     ...
     * @param comment       当前收到的评论
     */
    private void sendMailToParentComment(com.yond.entity.Comment parentComment, Comment comment) {
