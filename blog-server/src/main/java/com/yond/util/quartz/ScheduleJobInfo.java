...
import com.yond.util.common.SpringContextUtils;
...
public class ScheduleJobInfo extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.yond.entity.ScheduleJob scheduleJob = (com.yond.entity.ScheduleJob) context.getMergedJobDataMap().get(com.yond.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
